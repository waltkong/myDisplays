...
namespace app\library\frame\CacheCore\secache;
...
class secache{
    ...
    public $_file;
    public $_bsize_list;
    public $__support_usleep;
    public $_block_size_list;
    public $_rs;
    public $max_size;
    public $idx_node_base;
    const SECACHE_SIZE=15728640;
    ...
    function _format($truncate=false){
        if($this->lock(true,true)){
            ...
            $this->max_size = $this->_parse_str_size(self::SECACHE_SIZE,15728640); //default:15m
