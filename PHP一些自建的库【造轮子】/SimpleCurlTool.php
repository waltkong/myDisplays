...
class SimpleCurlTool
{
     ...
     * post方式
     */
    public static function postCurl($url, array $data=[]) {
     ...
     */
    public static function requestCurl($url,$requestType='post',$data=[],$cookie='',$ifGetReturnCookie=0,$referer='',$ifSpider=false){
        $curl = curl_init();
        ...
        if($ifSpider){
            curl_setopt($curl, CURLOPT_USERAGENT, self::getRandomAgent());
        }
